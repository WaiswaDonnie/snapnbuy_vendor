...
import { useMyProductsQuery, useProductsQuery } from '@/data/product';
...
export default function MyProductsPage() {
  ...
  const { products, paginatorInfo, loading, error } = useMyProductsQuery(
    {
      language: locale,
      name: searchTerm,
      limit: 20,
...
MyProductsPage.authenticate = {
  permissions: adminOwnerAndStaffOnly,
};
MyProductsPage.Layout = ShopLayout;
